...
class SeeMoreTopRatedMovie extends StatelessWidget {
  const SeeMoreTopRatedMovie({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<SeeMoreBloc>()..add(SeeMoreTopRatedEvent()),
